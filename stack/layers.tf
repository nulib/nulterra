resource "aws_lambda_layer_version" "common_layer" {
  ...
  source_code_hash    = filebase64sha256("${path.module}/../lambda_layers/build/common.zip")
...
resource "aws_lambda_layer_version" "image_utils_layer" {
  ...
  source_code_hash    = filebase64sha256("${path.module}/../lambda_layers/build/image-utils.zip")
