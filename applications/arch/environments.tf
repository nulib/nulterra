locals {
  database_url  = "postgresql://${local.app_name}:${module.archdb.password}@${data.terraform_remote_state.stack.db_address}:${data.terraform_remote_state.stack.db_port}/${local.app_name}?pool=50"
